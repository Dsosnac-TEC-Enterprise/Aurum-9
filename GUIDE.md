...
* **Investigation Pipe:** A controlled port (9999) remains open for forensic analysis.In terminal to perform forensics analysis run `python3 -m c2_kinetic_engine.forensic_triage`
