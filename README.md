...
pip install -r requirements.txt
   ```
**Run the self-healing logic to verify hash registry integrity:**
```bash
...
**Note:**
 To view Aurum-9 Operator's Manual and Enterprise Deployment (AWS, AZURE, K8s) see our Guide.md file in Docs folder.
