...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Architecture-C3MRS-gold?style=for-the-badge" />
</p>
...
graph TD
    ...
    B --> E[Monitor&Survey: Tactical HUD]
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/Sosnac/Aurum-9.git](https://github.com/Dsosnac-Tec-Enterprise/Aurum-9.git)
   cd Aurum-9
```
